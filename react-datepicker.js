    ...
    return (
      React.DOM.div({className: "datepicker"}, 
        ...
        React.DOM.div({className: "datepicker__header"}, 
          ...
          React.DOM.div({className: "currentMonth"}, 
          ...
          React.DOM.div({className: "nextMonth"}, 
            React.DOM.span({className: "datepicker__current-month"}, 
...
var Day = React.createClass({displayName: 'Day',
  ...
  render: function() {
    ...
    return (
      React.DOM.div({className: classes, onClick: this.props.onClick, onMouseEnter: this.test, onMouseLeave: this.test}, 
        this.props.day.day()
      )
    );
  }
