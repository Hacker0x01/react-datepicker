...
describe("DateInput", function() {
  ...
  it("should call onChange when changing from null to valid date", function() {
    var date = moment();
    var dateFormat = "YYYY-MM-DD";
    var callback = sinon.spy();
    var dateInput = TestUtils.renderIntoDocument(
      <DateInput date={null} dateFormat={dateFormat} onChange={callback} />
    );
  ...
  it("should call onChange when changing from valid date to another", function() {
    var dateFrom = moment();
    var dateTo = dateFrom.clone().add(1, "day");
    var dateFormat = "YYYY-MM-DD";
    var callback = sinon.spy();
    var dateInput = TestUtils.renderIntoDocument(
      <DateInput date={dateFrom} dateFormat={dateFormat} onChange={callback} />
    );
    var inputNode = dateInput.refs.input;
  ...
  it("should call onChange when changing from valid date to empty", function() {
    var callback = sinon.spy();
    var dateInput = TestUtils.renderIntoDocument(
      <DateInput date={moment()} onChange={callback} />
    );
    var inputNode = dateInput.refs.input;
    inputNode.value = "";
    TestUtils.Simulate.change(inputNode);
  ...
  it("should not call onChange when changing from valid date to invalid", function() {
    var callback = sinon.spy();
    var dateInput = TestUtils.renderIntoDocument(
      <DateInput date={moment()} onChange={callback} />
    );
  ...
  it("should call onChange when changing from invalid date to valid", function() {
    var dateFrom = moment();
    var dateTo = dateFrom.clone().add(1, "day");
    var dateFormat = "YYYY-MM-DD";
    var callback = sinon.spy();
  ...
  it("should not call onChange when changing to a disabled date", function() {
    var date = moment();
    var dateFormat = "YYYY-MM-DD";
    var callback = sinon.spy();
    var dateInput = TestUtils.renderIntoDocument(
      <DateInput date={null} excludeDates={[date]} dateFormat={dateFormat} onChange={callback} />
    );
    var inputNode = dateInput.refs.input;
    inputNode.value = date.format(dateFormat);
    TestUtils.Simulate.change(inputNode);
